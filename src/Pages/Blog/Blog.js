    ...
    return (
        <div className='my-5 p-5'>
            <div className=''>
                ...
                <p><span className='font-bold w-1/2'>SQL Database:</span> <br />1. RELATIONAL DATABASE MANAGEMENT SYSTEM (RDBMS). <br />2. These databases have fixed or static or predefined schema. <br />3. These databases are not suited for hierarchical data storage. <br />4. These databases are best suited for complex queries. <br />5. Vertically Scalable. <br />6. Follows ACID property. <br />7. Examples: MySQL, PostgreSQL, Oracle, MS-SQL Server etc,</p>
                <br />
                <p><span className='font-bold w-1/2'>NoSQL Database:</span> <br />1. Non-relational or distributed database system. <br />2. They have dynamic schema. <br />3. These databases are best suited for hierarchical data storage. <br />4. These databases are not so good for complex queries. <br />5. Horizontally scalable. <br />6. Follows CAP(consistency, availability, partition tolerance). <br />7. Examples: MongoDB, GraphQL, HBase, Neo4j, Cassandra etc.</p>
            </div>
            <br /><br />
            <div>
            ...
            <br /> <br />
            <div>
                <h2 className='text-2xl'>What is the difference between javascript and NodeJS?</h2>
